...
(defun initialize-default-key-bindings ()
  ...
  (define-key global-map (kbd "M-l")
    (:input-complete *minibuffer* set-url-new-buffer history-typed-complete))
  ...
  (define-key document-mode-map (kbd "C-l")
    (:input-complete *minibuffer* set-url history-typed-complete :setup #'setup-url))
  ...
  (define-key document-mode-map (kbd "S-l")
    (:input-complete *minibuffer* set-url history-typed-complete)))
