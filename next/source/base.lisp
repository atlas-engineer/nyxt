...
(defun initialize-default-key-bindings ()
  ...
  (define-key global-map (kbd "M-l") (:input *minibuffer* set-url-new-buffer))
  (define-key global-map (kbd "S-b k") (:input-complete *minibuffer* bookmark-delete bookmark-complete))
  ...
  (define-key document-mode-map (kbd "M-f") (:input-complete *minibuffer* history-forwards-query history-fowards-query-complete))
  ...
  (define-key document-mode-map (kbd "C-l") (:input *minibuffer* set-url))
  (define-key document-mode-map (kbd "S-b o") (:input-complete *minibuffer* set-url bookmark-complete))
