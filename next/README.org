...
*** TODO Deprecate Buffers
- Buffers serve as an unnecessary abstraction in next
- Create base class rich-buffer, all buffer types extend from it
- document-buffer, input-buffer, history-tree-buffer
