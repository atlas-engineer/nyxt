#+html: <img src="assets/icon_512x512.png" align="right"/>
* nEXT Browser
nEXT is the fastest productivity browser. It is designed from the
ground up to be customizable for your workflow.
...
* Powerful Features
Get your work done efficiently, in your own way, without frustration
nEXT ships with a suite of powerful features, but imposes no
constraints on customization and extension. Make it yours for your
unique workflow.
