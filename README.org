...
- [[https://aur.archlinux.org/packages/nyxt][Arch Linux AUR]] and the [[https://aur.archlinux.org/packages/nyxt-browser-git/][-git PKGBUILD]] which has an [[https://e-v.srht.site/nyxt-aur-builds.html][unofficial binary
  package]], courtesy of of @edgar-vincent.
