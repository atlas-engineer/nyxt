...
* Getting Started
** Install Next
See the [[https://github.com/atlas-engineer/next/releases][releases]] section for pre-built binaries. To perform an
installation from source, please see the [[https://github.com/atlas-engineer/next/tree/master/documents][developer readme]].
