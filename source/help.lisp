    ...
    (let* ((help-contents
             (markup:markup
              ...
              (:p "The minibuffer is a input area where you can
                   ...
                   minibuffer suggests.")              
              (:h3 "Message Area")
              (:p "The message area represents a space (typically at
                   the bottom of a window) where Next will output
                   messages back to you. To view the history of all
                   things printed in the messages area, invoke the
                   command 'messages'")
              (:h3 "Status Area")
              ...
              (:p "Next provides introspective and help
                   ...
                   described below:")
              (:ul
               (:li (:code (binding-keys 'help) " help") ": The command 'help' opens up a small help buffer.")
               (:li (:code (binding-keys 'tutorial) " tutorial") ": The command 'tutorial' opens up this tutorial.")
               (:li (:code (binding-keys 'describe-key) " describe-key") ": The command 'describe-key' allows you to input a
                     key binding and see what command it is bound
                     to.")
               (:li (:code (binding-keys 'describe-slot) " describe-slot") ": The command 'describe-slot' allows you to find
                     out the value of a particular class slot and view
                     its documentation.")
               (:li (:code (binding-keys 'describe-command) " describe-command") ": The commmand 'describe-command' allows you to
                     find out about a particular command (including
                     showing its source).")
               (:li (:code (binding-keys 'describe-bindings) " describe-bindings") ": The command 'describe-bindings' to view all of
                     your currently set bindings in your buffer.")
               (:li (:code (binding-keys 'describe-variable) " describe-variable") ": The command 'describe-variable' allows you to
