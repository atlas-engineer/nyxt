...
(define-mode document-mode (mode)
  ...
  (define-key *document-mode-map* (key "M-g") 'go-anchor-new-buffer)
  (define-key *document-mode-map* (key "S-g") 'go-anchor-new-buffer-focus)
  ...
  (define-key *document-mode-map* (key "S-s k") 'remove-search-hints)
