...
(define-mode document-mode (mode)
  ...
  (define-key *document-mode-map* (key "C-b o") 'set-url-from-bookmark)
  (define-key *document-mode-map* (key "C-b s") 'bookmark-current-page)
  (define-key *document-mode-map* (key "C-b g") 'bookmark-anchor)
