...
(define-class nyxt-remote-file (nyxt-file nfiles:remote-file)
  ()
  (:export-class-name-p t)
  (:accessor-name-transformer (class*:make-name-transformer name))
  (:documentation "A nfiles:remote-file with specialized methods."))

(defmethod nfiles:fetch ((profile nyxt-profile) (file nyxt-remote-file) &key)
