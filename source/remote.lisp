...
by Next when the user session dbus instance is not available.")
   ...
   (minibuffer-generic-history :accessor minibuffer-generic-history :initform (ring:make-ring))
   (minibuffer-search-history :accessor minibuffer-search-history :initform (ring:make-ring))
   (minibuffer-set-url-history :accessor minibuffer-set-url-history :initform (ring:make-ring))
