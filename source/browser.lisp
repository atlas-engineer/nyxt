...
(defmacro define-ffi-generic-method (name arguments)
  `(progn
     (export-always ',name)
     (defgeneric ,name (,@arguments))))

(define-ffi-generic-method ffi-window-delete (window))
(define-ffi-generic-method ffi-window-fullscreen (window))
(define-ffi-generic-method ffi-window-unfullscreen (window))
(define-ffi-generic-method ffi-buffer-uri (buffer))
(define-ffi-generic-method ffi-buffer-title (buffer))
(define-ffi-generic-method ffi-window-make (browser))
(define-ffi-generic-method ffi-window-to-foreground (window))
(define-ffi-generic-method ffi-window-set-title (window title))
(define-ffi-generic-method ffi-window-active (browser))
(define-ffi-generic-method ffi-window-set-active-buffer (window buffer))
(define-ffi-generic-method ffi-window-set-minibuffer-height (window height))
(define-ffi-generic-method ffi-window-set-status-buffer-height (window height))
(define-ffi-generic-method ffi-window-set-message-buffer-height (window height))
(define-ffi-generic-method ffi-window-get-status-buffer-height (window))
(define-ffi-generic-method ffi-window-get-message-buffer-height (window))
(define-ffi-generic-method ffi-buffer-make (browser))
(define-ffi-generic-method ffi-buffer-delete (buffer))
(define-ffi-generic-method ffi-buffer-load (buffer uri))
(define-ffi-generic-method ffi-buffer-evaluate-javascript (buffer javascript))
(define-ffi-generic-method ffi-buffer-evaluate-javascript-async (buffer javascript))
(define-ffi-generic-method ffi-minibuffer-evaluate-javascript (window javascript))
(define-ffi-generic-method ffi-buffer-enable-javascript (buffer value))
(define-ffi-generic-method ffi-buffer-enable-javascript-markup (buffer value))
(define-ffi-generic-method ffi-buffer-enable-smooth-scrolling (buffer value))
(define-ffi-generic-method ffi-buffer-enable-media (buffer value))
(define-ffi-generic-method ffi-buffer-auto-load-image (buffer value))
(define-ffi-generic-method ffi-buffer-enable-sound (buffer value))
(define-ffi-generic-method ffi-buffer-user-agent (buffer value))
(define-ffi-generic-method ffi-buffer-set-proxy (buffer &optional proxy-uri ignore-hosts))
(define-ffi-generic-method ffi-buffer-get-proxy (buffer))
(define-ffi-generic-method ffi-generate-input-event (window event))
(define-ffi-generic-method ffi-generated-input-event-p (window event))
(define-ffi-generic-method ffi-within-renderer-thread (browser thunk))
(define-ffi-generic-method ffi-kill-browser (browser))
(define-ffi-generic-method ffi-initialize (browser urls startup-timestamp))
(define-ffi-generic-method ffi-inspector-show (buffer))
(define-ffi-generic-method ffi-print-status (window text))
(define-ffi-generic-method ffi-print-message (window message))
(define-ffi-generic-method ffi-display-uri (text))
(define-ffi-generic-method ffi-buffer-cookie-policy (buffer value))
(define-ffi-generic-method ffi-set-preferred-languages (buffer value))
