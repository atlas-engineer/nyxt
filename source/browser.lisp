...
(defgeneric ffi-window-delete (window))
(defgeneric ffi-window-fullscreen (window))
(defgeneric ffi-window-unfullscreen (window))
(defgeneric ffi-buffer-uri (buffer))
(defgeneric ffi-buffer-title (buffer))
(defgeneric ffi-window-make (browser))
(defgeneric ffi-window-to-foreground (window))
(defgeneric ffi-window-set-title (window title))
(defgeneric ffi-window-active (browser))
(defgeneric ffi-window-set-active-buffer (window buffer))
(defgeneric ffi-window-set-minibuffer-height (window height))
(defgeneric ffi-buffer-make (browser))
(defgeneric ffi-buffer-delete (buffer))
(defgeneric ffi-buffer-load (buffer uri))
(defgeneric ffi-buffer-evaluate-javascript (buffer javascript))
(defgeneric ffi-minibuffer-evaluate-javascript (window javascript))
(defgeneric ffi-buffer-enable-javascript (buffer value))
(defgeneric ffi-buffer-enable-javascript-markup (buffer value))
(defgeneric ffi-buffer-enable-smooth-scrolling (buffer value))
(defgeneric ffi-buffer-enable-media (buffer value))
(defgeneric ffi-buffer-auto-load-image (buffer value))
(defgeneric ffi-buffer-user-agent (buffer value))
(defgeneric ffi-buffer-set-proxy (buffer &optional proxy-uri ignore-hosts))
(defgeneric ffi-buffer-get-proxy (buffer))
(defgeneric ffi-generate-input-event (window event))
(defgeneric ffi-generated-input-event-p (window event))
(defgeneric ffi-within-renderer-thread (browser thunk))
(defgeneric ffi-kill-browser (browser))
(defgeneric ffi-initialize (browser urls startup-timestamp))
(defgeneric ffi-inspector-show (buffer))
(defgeneric ffi-print-status (window text))
(defgeneric ffi-print-message (window message))
(defgeneric ffi-buffer-cookie-policy (buffer value))
