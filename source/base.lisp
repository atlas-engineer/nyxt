...
(defun initialize-default-key-bindings ()
  ...
  (define-key *minibuffer-mode-map* (kbd "Right") #'(lambda () (cursor-forwards *minibuffer*)))
  (define-key *minibuffer-mode-map* (kbd "Left") #'(lambda () (cursor-backwards *minibuffer*)))
  (define-key *minibuffer-mode-map* (kbd "C-d") #'(lambda () (delete-forwards *minibuffer*)))
  (define-key *minibuffer-mode-map* (kbd "DELETE") #'(lambda () (delete-forwards *minibuffer*)))
  ...
  (define-key *minibuffer-mode-map* (kbd "Down") #'(lambda () (select-next *minibuffer*)))
  (define-key *minibuffer-mode-map* (kbd "Up") #'(lambda () (select-previous *minibuffer*))))
