...
(defun initialize-default-key-bindings ()
  ...
  (define-key *minibuffer-mode-map* (kbd "a") #'(lambda () (self-insert *minibuffer* "a")))
  (define-key *minibuffer-mode-map* (kbd "b") #'(lambda () (self-insert *minibuffer* "b")))
  (define-key *minibuffer-mode-map* (kbd "c") #'(lambda () (self-insert *minibuffer* "c")))
  (define-key *minibuffer-mode-map* (kbd "d") #'(lambda () (self-insert *minibuffer* "d")))
  (define-key *minibuffer-mode-map* (kbd "e") #'(lambda () (self-insert *minibuffer* "e")))
  (define-key *minibuffer-mode-map* (kbd "f") #'(lambda () (self-insert *minibuffer* "f")))
  (define-key *minibuffer-mode-map* (kbd "g") #'(lambda () (self-insert *minibuffer* "g")))
  (define-key *minibuffer-mode-map* (kbd "h") #'(lambda () (self-insert *minibuffer* "h")))
  (define-key *minibuffer-mode-map* (kbd "i") #'(lambda () (self-insert *minibuffer* "i")))
  (define-key *minibuffer-mode-map* (kbd "j") #'(lambda () (self-insert *minibuffer* "j")))
  (define-key *minibuffer-mode-map* (kbd "k") #'(lambda () (self-insert *minibuffer* "k")))
  (define-key *minibuffer-mode-map* (kbd "l") #'(lambda () (self-insert *minibuffer* "l")))
  (define-key *minibuffer-mode-map* (kbd "m") #'(lambda () (self-insert *minibuffer* "m")))
  (define-key *minibuffer-mode-map* (kbd "n") #'(lambda () (self-insert *minibuffer* "n")))
  (define-key *minibuffer-mode-map* (kbd "o") #'(lambda () (self-insert *minibuffer* "o")))
  (define-key *minibuffer-mode-map* (kbd "p") #'(lambda () (self-insert *minibuffer* "p")))
  (define-key *minibuffer-mode-map* (kbd "q") #'(lambda () (self-insert *minibuffer* "q")))
  (define-key *minibuffer-mode-map* (kbd "r") #'(lambda () (self-insert *minibuffer* "r")))
  (define-key *minibuffer-mode-map* (kbd "s") #'(lambda () (self-insert *minibuffer* "s")))
  (define-key *minibuffer-mode-map* (kbd "t") #'(lambda () (self-insert *minibuffer* "t")))
  (define-key *minibuffer-mode-map* (kbd "u") #'(lambda () (self-insert *minibuffer* "u")))
  (define-key *minibuffer-mode-map* (kbd "v") #'(lambda () (self-insert *minibuffer* "v")))
  (define-key *minibuffer-mode-map* (kbd "w") #'(lambda () (self-insert *minibuffer* "w")))
  (define-key *minibuffer-mode-map* (kbd "x") #'(lambda () (self-insert *minibuffer* "x")))
  (define-key *minibuffer-mode-map* (kbd "y") #'(lambda () (self-insert *minibuffer* "y")))
  (define-key *minibuffer-mode-map* (kbd "z") #'(lambda () (self-insert *minibuffer* "z")))
  (define-key *minibuffer-mode-map* (kbd ":") #'(lambda () (self-insert *minibuffer* ":")))
  (define-key *minibuffer-mode-map* (kbd "/") #'(lambda () (self-insert *minibuffer* "/")))
  (define-key *minibuffer-mode-map* (kbd ".") #'(lambda () (self-insert *minibuffer* ".")))
