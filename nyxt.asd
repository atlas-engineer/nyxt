...
(defsystem "nyxt"
  ...
  :components ((:file "package")
               ...
               (:file "mode/repl-mode")
               (:file "mode/help-mode")
               (:file "mode/message-mode")
               (:file "mode/application-mode")
               (:file "mode/history-tree-mode")
               (:file "mode/list-history-mode")
               (:file "mode/web-mode")
               (:file "mode/reading-line-mode")
               (:file "mode/style-mode")
               (:file "mode/certificate-exception-mode")
               (:file "mode/emacs-mode")
               (:file "mode/vi-mode")
               (:file "mode/blocker-mode")
               (:file "mode/proxy-mode")
               (:file "mode/no-image-mode")
               (:file "mode/no-sound-mode")
               (:file "mode/no-script-mode")
               (:file "mode/no-webgl-mode")
               (:file "mode/reduce-bandwidth-mode")
               (:file "mode/download-mode")
               (:file "mode/force-https-mode")
               (:file "mode/reduce-tracking-mode")
               (:file "mode/os-package-manager-mode")
               (:file "mode/visual-mode")
               (:file "mode/process-mode")
               (:file "mode/repeat-mode")
               (:file "mode/cruise-control-mode")
               (:file "mode/watch-mode")
               (:file "mode/preview-mode")
               (:file "mode/diff-mode")
