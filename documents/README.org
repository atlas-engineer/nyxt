...
- [[#developer-installation][Developer Installation]]
  ...
  - [[#gnulinux-setup][GNU/Linux Setup]]
...
4. Execute ~(ql:quickload :next)~ to load the Next system into your
   Lisp image.
5. Start your platform-port (the GTK or Cocoa platform-port application)
...
install a separate quicklisp installation for Next. Please see the
Makefile for more details.

*** Build a Linux binary
Execute =make next-gtk=.

*** MacOS Compilation
Execute =make next-cocoa=.
