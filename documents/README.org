...
- [[#developer-installation][Developer Installation]]
  ...
  - [[#gnu-linux-setup-experimental][GNU/Linux Setup (Experimental)]]
...
Next is written in Common Lisp. It can be built with
...
provided via Cocoa for MacOS and GTK for GNU/Linux. To download a prebuilt-binary,
please see the "Releases" section of the GitHub repository
([[https://github.com/atlas-engineer/next/releases]]).
...
and the compiled binary will be placed in the directory ~source~ as ~next-gtk~.
...
** Mailing List
Next maintains a GNU Mailman server located at
[[http://mail.next-browser.com/listinfo]].

*** Developer Mailing List
You can sign up for the [[http://mail.next-browser.com/listinfo/development][developer mailing list]] to participate in
discussions on the engineering and programming of Next.

*** Alpha Mailing List
You can up for the [[http://mail.next-browser.com/listinfo/alpha][alpha mailing list]] to participate in discussions on
feature requests, and early version testing.

* Release Timeline

From version 0.9 onward, Next uses [[https://semver.org/][Semantic Versioning]].
In short, given a version number MAJOR.MINOR.PATCH, we increment the:
...
MacOS, self contained dmg etc. On GNU/Linux it should do the equivalent,
but with flatpak or [[https://guix.info/blog/2018/tarballs-the-ultimate-container-image-format/][guix pack]].

**** TODO Compilation Script Linux
**** TODO Compilation Script MacOS
** 0.9
*** TODO GNU/Linux Frontend
