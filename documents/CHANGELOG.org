...
+ Proposed format:
  #+begin_src
  (:url "https://en.wikipedia.org/wiki/Main_Page" :title "Wikipedia, the free encyclopedia" :shortcut "wiki" :search "http://en.wikipedia.org/wiki/Special:Search?search=%s" :time "Sat Jul 14 09:41:56 2018")
  #+end_src
  Minibuffer usage:
