...
(loop for i from 1 to 1000
      do (ring::ring-insert test-ring1 (make-string i :initial-element #/a)))
...
(prove:subtest "Add 1000 items, test head-index, item-count, first of recent-list length."
  ...
  (prove:is 1000
      (length (first (ring::ring-recent-list test-ring1)))))


(loop for i from 1 to 5
      do (ring::ring-insert test-ring1 (make-string i :initial-element #/b)))
...
(prove:subtest "Add 5 more items; test head-index, item-count, first recent-list, value at head-index, and (1- head-index)."
  ...
  (prove:is 1000
      (ring::item-count test-ring1))
  (prove:is "bbbbb"
      (first (ring::ring-recent-list test-ring1)))
  (prove:is "aaaaaa"
