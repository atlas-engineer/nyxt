This minibuffer library is heavily inspired by Emacs' [[https://emacs-helm.github.io/helm/][Helm]].
...
- Per-source history.
- Per-source keymaps.
- Resumable minibuffers.
- Persistent action (executed without closing the minibuffer).
